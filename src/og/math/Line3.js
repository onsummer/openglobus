...
class Line3 {
    ...
    intersects(line, res, res2) {
        ...
        if (
            Math.abs(p43.x) < math.EPSILON10 &&
            Math.abs(p43.y) < math.EPSILON10 &&
            Math.abs(p43.z) < math.EPSILON10
        ) {
            return false;
        }
        ...
        if (
            Math.abs(p21.x) < math.EPSILON10 &&
            Math.abs(p21.y) < math.EPSILON10 &&
            Math.abs(p21.z) < math.EPSILON10
        ) {
            return false;
        }
