...
class Ray {
     ...
     * @returns {number} - Hit code, could 0 - Ray.OUTSIDE, 1 - Ray.INSIDE,
     *      2 - Ray.INPLANE and 3 - Ray.AWAY(ray goes away from triangle).
     */
    ...
    /**
     * Gets a ray hit a plane result. If the ray cross the plane returns 1 - Ray.INSIDE otherwise returns 0 - Ray.OUTSIDE.
     * @public
 ...
 * @static
 */
Ray.OUTSIDE = Object.freeze(0);
/**
 * @constant
 * @readonly
 * @static
 */
Ray.INSIDE = Object.freeze(1);
/**
 * @constant
 * @readonly
 * @static
 */
Ray.INPLANE = Object.freeze(2);
/**
 * @constant
 * @readonly
 * @static
 */
Ray.AWAY = Object.freeze(3);
