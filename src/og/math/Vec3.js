...
class Vec3 {
    ...
    static doubleToTwoFloats(value, high, low) {
        ...
        if (x >= 0.0) {
            const doubleHigh = Math.floor(x / 65536.0) * 65536.0;
        ...
        if (y >= 0.0) {
            const doubleHigh = Math.floor(y / 65536.0) * 65536.0;
        ...
        if (z >= 0.0) {
            const doubleHigh = Math.floor(z / 65536.0) * 65536.0;
 ...
 * @readonly
 */
Vec3.BACKWARD = Object.freeze(new Vec3(0, 0, 1));
/**
 * @static
 * @readonly
 */
Vec3.ZERO = Object.freeze(new Vec3());
/**
 * @static
 * @readonly
 */
 ...
 * @readonly
 */
Vec3.LERP_DELTA = Object.freeze(1e-6);
