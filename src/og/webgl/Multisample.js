...
class Multisample {
     ...
     * @param {boolean} forceDestroy - Indicate if force destroy
     */
     ...
     * @public
     * @returns {Multisample} - Returns Current framebuffer.
     */
    activate() {
        const gl = this.handler.gl;
        gl.bindFramebuffer(gl.FRAMEBUFFER, null);
        ...
        this._active = true;
        const c = this.handler.framebufferStack.current().data;
        c && (c._active = false);
    ...
    deactivate() {
        ...
        const f = this.handler.framebufferStack.popPrev();
