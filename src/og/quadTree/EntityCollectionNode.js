...
class EntityCollectionNode {
    ...
    createChildrenNodes() {
        ...
        nd[quadTree.NW] = new EntityCollectionNode(
            l,
            quadTree.NW,
            this,
            id,
        ...
        nd[quadTree.NE] = new EntityCollectionNode(
            l,
            quadTree.NE,
            this,
            id,
        ...
        nd[quadTree.SW] = new EntityCollectionNode(
            l,
            quadTree.SW,
            this,
            id,
        ...
        nd[quadTree.SE] = new EntityCollectionNode(
            l,
            quadTree.SE,
            this,
            id,
    ...
    collectRenderCollectionsPASS2(visibleNodes, outArr, renderingNodeId) {
        ...
        var altVis =
            cam.eye.distance(this.bsphere.center) - this.bsphere.radius <
                quadTree.VISIBLE_DISTANCE * Math.sqrt(cam._lonLat.height) ||
            cam._lonLat.height > 10000;
        ...
        if (
            ...
            if (this.entityCollection) {
                ...
                cn[quadTree.NW].collectRenderCollectionsPASS2(
                    visibleNodes,
                    outArr,
                    renderingNodeId
                );
                cn[quadTree.NE].collectRenderCollectionsPASS2(
                    visibleNodes,
                    outArr,
                    renderingNodeId
                );
                cn[quadTree.SW].collectRenderCollectionsPASS2(
                    visibleNodes,
                    outArr,
                    renderingNodeId
                );
                cn[quadTree.SE].collectRenderCollectionsPASS2(
                    visibleNodes,
                    outArr,
                    renderingNodeId
                );
    ...
    renderCollection(outArr, visibleNodes, renderingNodeId) {
        ...
        if (l.clampToGround || l.relativeToGround) {
            ...
            if (
                visibleNodes[this.nodeId] &&
                visibleNodes[this.nodeId].state === quadTree.RENDERING
            ) {
                while (i--) {
                    let ei = e[i];
    ...
    alignEntityToTheGround(entity, segment) {
        ...
        entity._setCartesian3vSilent(
            res.addA(
                res.normal().scale((Number(this.layer.relativeToGround) && entity._altitude) || 0.0)
            )
        );
    }
    isVisible() {
...
class EntityCollectionNodeWGS84 {
    constructor(layer, partId, parent, id, extent, planet, zoom) {
    ...
    createChildrenNodes() {
        ...
        nd[quadTree.NW] = new EntityCollectionNodeWGS84(
            l,
            quadTree.NW,
            this,
            id,
        ...
        nd[quadTree.NE] = new EntityCollectionNodeWGS84(
            l,
            quadTree.NE,
            this,
            id,
        ...
        nd[quadTree.SW] = new EntityCollectionNodeWGS84(
            l,
            quadTree.SW,
            this,
            id,
        ...
        nd[quadTree.SE] = new EntityCollectionNodeWGS84(
            l,
            quadTree.SE,
            this,
            id,
