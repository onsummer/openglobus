        ...
        if (this._planet.layerLock.isFree() && this._queue.length) {
            ...
            while (this._planet.layerLock.isFree() && this._queue.length && deltaTime < 0.25) {
                ...
                if (material.isLoading && material.segment.node.getState() === quadTree.RENDERING) {
                    ...
                    texture =
                        (material._updateTexture && material._updateTexture) ||
                        h.createEmptyTexture_l(width, height);
                    ...
                    gl.vertexAttribPointer(
                        sha.colors,
                        geomHandler._polyColorsBuffer.itemSize,
                        gl.FLOAT,
                        false,
                        0,
                        0
                    ...
                    gl.drawElements(
                        gl.TRIANGLES,
                        geomHandler._polyIndexesBuffer.numItems,
                        gl.UNSIGNED_INT,
                        0
                    );
                    ...
                    gl.vertexAttribPointer(
                        sha.order,
                        geomHandler._lineOrdersBuffer.itemSize,
                        gl.FLOAT,
                        false,
                        4,
                        0
                    ...
                    gl.vertexAttribPointer(
                        sha.color,
                        geomHandler._lineColorsBuffer.itemSize,
                        gl.FLOAT,
                        false,
                        0,
                        0
